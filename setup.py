...
def show_current_config(config: Dict[str, Any]):
    ...
    print(f"   Samples Per Dataset: {training.get('samples_per_dataset', 50)}")
...
def configure_training(config: Dict[str, Any]):
    ...
    training['samples_per_dataset'] = get_input("Samples per dataset per chunk", training.get('samples_per_dataset', 50), int)
